...
pattern0.add(M(node=0, plane="XY", angle=0.0, s_domain=[], t_domain=[]))
pattern0.add(M(node=1, plane="XY", angle=0.0, s_domain=[0], t_domain=[]))
...
pattern1.add(M(node=0, plane="XY", angle=0.0, s_domain=[], t_domain=[]))
pattern1.add(X(node=1, domain=[0]))
pattern1.add(N(node=2))
pattern1.add(E(nodes=(1, 2)))
pattern1.add(M(node=1, plane="XY", angle=0.0, s_domain=[], t_domain=[]))
